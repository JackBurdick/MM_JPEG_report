...
# create dictionary for huffman look up (per specifications)
...
#         cur_val = cur_pair[1]
#         huffman_dict[cur_key] = cur_val
create_bin_dict(22)
print(huffman_dict)
# Ensure we've captured the correct values
# print(original_image)
# print(sorted(huffman_dict.values()))
